...
const ArticleDetail = ({ article }) => {
  return (
    <main className="w-full mx-auto bg-graph-paper p-4">
     <div className="flex justify-center">
        <div className="text-center py-4 m-4 w-full max-w-sm relative">
          ...
          <h1 className="text-2xl font-bold relative inline-block bg-white px-4 z-10">
            {article.title}
          </h1>
        ...
        <div className="flex justify-center">
        <div className={`articleContent m-4 p-4 bg-white rounded-lg prose prose-lg w-full max-w-4xl ${styles.articleContent}`} dangerouslySetInnerHTML={{ __html: article.body }} />
